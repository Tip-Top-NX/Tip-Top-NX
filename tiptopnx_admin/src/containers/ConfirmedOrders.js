...
import { Paper, Typography, Grid, TextField, Dialog, DialogActions, DialogTitle } from '@material-ui/core';
...
const ConfirmedOrders = (props) => {
    ...
    const statusUpdate = () => {
        axios.put("/admin/orders/" + selected._id, { status: "Delivered", deliveryDate:new Date() }, getConfig())
            .then((res) => {
                setAlertOpen(false);
                props.fetchOrders();
            })
                    ...
                    <tbody>
                        {orders.map((order, index) => (
                            <tr key={index}>
                                ...
                                <td align="center">
                                    <Button2 onClick={() => {setAlertOpen(true);setSelected(order);}} variant="contained" color="secondary">
                                        <Done />
                                    </Button2>
                                </td>
                            </tr>
