...
class Login extends React.Component {
      ...
      axios
        ...
        .then((res) => {
          if (res.data.success === true && res.data.user.admin) {
            ...
            return axios.get("/admin/orders/", getConfig())
          } else {
            this.setOpen(false);
  ...
  setOpen = (val) => {
    if (val === true) {
      this.setState({ ...this.state, spinner: true, invalid: false });
    }
    else {
      this.setState({ ...this.state, spinner: val });
    }
  }
        ...
        <div className={classes.container}>
          ...
          <div className={classes.content}>
            <div className={classes.frame}>
              ...
              <div style={{ display: this.state.spinner === true ? "block" : "none" }}>
