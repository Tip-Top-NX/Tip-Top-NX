...
const handleItem = [
    ...
    {
        name: "Edit",
        icon: <EditIcon style={{ height: 30, width: 30, color: "silver" }} />,
    },
    {
        name: "Delete",
        icon: <DeleteIcon style={{ height: 30, width: 30, color: "silver" }} />,
    },
    {
        name: "Search",
...
const handleOrder = ["Pending Orders", "Delivery Status"];
