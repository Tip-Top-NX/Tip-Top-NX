...
import { filteredOptionsAcc } from "./FilterOptions";
    ...
    <SafeAreaView style={styles.overAllContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.filteredOptionsStyle}>
          <FlatList
            data={filteredOptionsAcc[selectedFilter]}
            keyExtractor={(item, index) => index.toString()}
            showsVerticalScrollIndicator={false}
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (
                    ...
                    filteredOptionsAcc[selectedFilter][index] ===
                      filteredOptionsAcc[selectedFilter][selectedOption]
                  ) {
                    ...
                    setSelectedOption(
                      filteredOptionsAcc[selectedFilter].indexOf(item)
                    ),
                      setProdId(item.id);
                    ...
                    setPriceLower([
                      ...priceLower,
                      filteredOptionsAcc[selectedFilter][index].priceLower,
                    ]);
                    setPriceUpper([
                      ...priceUpper,
                      filteredOptionsAcc[selectedFilter][index].priceUpper,
                    ]);
                    setAllSelected([
                      ...allSelected,
                      filteredOptionsAcc[selectedFilter][index],
                    ...
                    style={[
                      styles.eachFilterText,
                      {
                        color:
                          filteredOptionsAcc[selectedFilter].indexOf(item) ===
                            selectedOption ||
                          filteredOptionsAcc[selectedFilter][
                            filteredOptionsAcc[selectedFilter].indexOf(item)
                          ] ===
                            allSelected.find(
                              (i) =>
                                i ===
                                filteredOptionsAcc[selectedFilter][
                                  filteredOptionsAcc[selectedFilter].indexOf(
                                    item
                                  )
                                ]
                            )
